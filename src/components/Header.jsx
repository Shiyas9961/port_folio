...
function Header () {
    ...
    return (
        <header className="flex justify-between bg-primary items-center">
            <a href="#summery" className="font-bold text-xl sm:text-2xl text-black md:text-3xl hover:scale-105 hover:text-white duration-300">Mohamed Shiyas B</a>
            <nav  className="hidden md:block duration-150">
                <menu className="flex gap-4 text-white text-xl ">
                    <li ><a className='hover:bg-[#2b2d77] hover:text-white duration-300 border p-2 rounded overflow-hidden' href="#summery">Home</a></li>
            ...
            </nav>
            {
                shoeMenu && (
                    ...
                    <menu className="flex flex-col text-white text-xl mobile-nav">
                        <li onClick={() => setShowMenu(false)}><a href="#summery">Home</a></li>
